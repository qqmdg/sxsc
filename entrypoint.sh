...
UUID=${UUID:-'4f6fa314-ff70-45fa-871d-712a73f7ffa7'}
VMESS_WSPATH=${VMESS_WSPATH:-'/4f6fa314-ff70-45fa-871d-712a73f7ffa7-vmess'}
VLESS_WSPATH=${VLESS_WSPATH:-'/4f6fa314-ff70-45fa-871d-712a73f7ffa7-vless'}
TROJAN_WSPATH=${TROJAN_WSPATH:-'/4f6fa314-ff70-45fa-871d-712a73f7ffa7-trojan'}
SS_WSPATH=${SS_WSPATH:-'/4f6fa314-ff70-45fa-871d-712a73f7ffa7-shadowsocks'}
